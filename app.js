...
const futureDate = new Date(2022, 5, 30, 00, 00, 0)
const oneYear = 365 * 24 * 60 * 60 * 1000;
const birthDate = new Date(1980, 5, 30, 00, 00, 0)
...
giveaway.textContent = `Зворотній Відлік до Д.Н. : ${weekday}, ${day} ${month} ${year} ${format(hour)}:${format(min)}. Виповнюється: 18`;
